...
public abstract class Tree implements Serializable
{
    ...
    protected void buildTree(Tree oldTree)
    {
        ...
        Enumeration _enum = siblingGroups.keys();
        while (_enum.hasMoreElements())
        {
            Integer  key = (Integer) _enum.nextElement();
    ...
    public void removeSubtree(NodeData ndn)
    {
        ...
        Enumeration _enum = allDescendentSiblingGroups.keys();
        while (_enum.hasMoreElements())
        {
            Integer key = (Integer) _enum.nextElement();
    ...
    protected Vector buildVectorOfTaxIDs(Hashtable siblingGroups)
    {
        ...
        Enumeration _enum = siblingGroups.elements();
        while (_enum.hasMoreElements())
        {
            Vector siblingGroup = (Vector) _enum.nextElement();
    ...
    private Vector convertSiblingGroupsToNodes(Hashtable siblingGroups)
    {
        ...
        while (_enum.hasMoreElements())
        {
            Vector vector  = (Vector) _enum.nextElement();
